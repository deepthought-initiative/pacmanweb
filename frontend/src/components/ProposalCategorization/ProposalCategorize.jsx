...
const ProposalCategorize = () => {
  ...
  const handleClick = async(event) => {
    ...
    const spawnResponse = await fetch("http://127.0.0.1:5000/api/run_pacman?mode=PROP&main_test_cycle=221026", {
      method: "GET",
      headers: { 
  ...
  return (
    <div className="mt-5" id="main-container">
        ...
        {showTable ? (
          <ProposalTable currentId={currentId} setShowTable={setShowTable} setShowLogs={setShowLogs}/>
        ) 
        : 
        (
          showLogs ? (
