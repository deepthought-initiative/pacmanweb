...
const TableMatchReviewers = () => {
 const [highlighted, setHighlighted] = useState()
  ...
  return (
    <>
        <div id="outer-table-container" className="container-fluid border border-1 border-black mt-5 rounded-3">
            ...
            <div className='col-3 px-3'>
                ...
                <div className='scroll-table-container'>
                  <table className="container-fluid p-0">
                    <thead>
                      <tr>
                          <th className="col-md-2 col-sm-1">Cycle Number</th>                            <th className="col-md-2 col-sm-1">CS Score</th>
                      </tr>
                    </thead>
                    <tbody>
                    {data.map((row) => (
